...
(function (factory) {
    ...
    $.fn.fileinput.defaults = {
        ...
        browseIcon: '<i class="clip-folder-open"></i>&nbsp;',
        browseClass: 'btn btn-primary',
        removeIcon: '<i class="clip-cogs"></i>',
        removeClass: 'btn btn-default',
        cancelIcon: '<i class="clip-home-2"></i>',
        cancelClass: 'btn btn-default',
        uploadIcon: '<i class="clip-upload"></i>',
        ...
        zoomIndicator: '<i class="clip-home"></i>',
