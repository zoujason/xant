...
;(function ($, window, document, undefined) {
    ...
    var Plugin = function (elem, options) {
        ...
        this.$tab_list = this.$wrapper.find('.zwgk_ysqgk_right_tab_title').find('.zwgk_ysqgk_right_item');
        this.$tabCont_wrap = this.$wrapper.find('.zwgk_ysqgk_right_tab_cont_wrap');
        this.$tab_cont = this.$tabCont_wrap.find('.zwgk_ysqgk_right_item');
    ...
    Plugin.prototype = {
        ...
        tabInital: function () { // 初始化当前显示
            ...
            this.$tab_list.removeClass('zwgk_ysqgk_right_item_cur');
            this.$tab_list.eq(curNum).addClass('zwgk_ysqgk_right_item_cur');
        ...
        changeTab: function (index) { // 选项卡切换
            this.$tab_list.removeClass('zwgk_ysqgk_right_item_cur');
            this.$tab_list.eq(index).addClass('zwgk_ysqgk_right_item_cur');
